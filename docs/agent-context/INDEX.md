...
| --- | --- | --- | --- | --- | --- |
| [`financial-provider-logo-catalogue-2026-08-22.md`](financial-provider-logo-catalogue-2026-08-22.md) | User-supplied provider lists and explicit reusable Admin logo-library direction, with derived reconciliation notes | 2026-08-22 | authoritative for the provider-candidate corpus and media-library requirement; raw names and product mapping remain unresolved | Financial Services provider catalogue, explicit product/provider configuration, approved logo media, public provider display, and internal-only application journeys | Current `Bank.logo_key` is an unmanaged string; missing bank/product availability currently means available; existing managed upload flows reject SVG. Canonical identities, Group A/B mapping, vehicle subgroups, and the truncated equipment list require confirmation before seeding. |
