...
| [`current-implementation-state.md`](current-implementation-state.md) | Derived from current code/tests/history, supplied sources, and explicit user decisions | 2026-08-09 | authoritative for the listed amendments | Platform-wide implementation decisions, resolved design items, and open gaps | Supersedes only the conflicts explicitly identified as CS-001 through CS-010; it does not rewrite the supplied source documents. |
