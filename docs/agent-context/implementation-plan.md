...
Provenance-based edit ownership (FR-2.8) is delivered on the current branch,
pending PR linkage.
...
| --- | --- | --- |
| 2026-08-11 | Completed provenance-based lead-detail ownership (FR-2.8) and promoted the remaining Admin operational coverage audit (FR-2.2). | Current branch, PR pending; additive ownership migration/trigger/RLS, Agent/Client/Admin APIs, Client/Admin UI, generated contracts, migration round-trip/one-head, focused API/RLS/static/web tests, and security review. |
