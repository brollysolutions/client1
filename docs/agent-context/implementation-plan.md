...
| 0 | Dev-seed Indian mobile-number correctness (maintenance) | **In progress** on `codex/20260812-112811-yeah-create-pr-for-dev-seed`: review and ship the existing shared synthetic-number helper for Agent-application, Telecaller, and affected test generators. | `gpt-5.6-terra` / Medium | `gpt-5.6-terra` / Medium | Ten-digit, 6–9-prefixed Indian local numbers are generated; public E.164 validation, authorization, RLS, and production intake behavior are unchanged. |
