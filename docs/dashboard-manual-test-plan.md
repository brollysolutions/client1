...
| CL-L-006 | Open Compare Loan Offers; add/remove banks until the shortlist limit; compare configured terms; continue to Apply. | Only available active bank/type combinations render; limit messaging is clear; removing restores capacity; Apply navigation works. |
