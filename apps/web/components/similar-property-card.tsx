  ...
  return (
    <li>
      <Link
        ...
        className="group flex gap-3 rounded-xl border border-[var(--nav-border)] bg-card p-3 transition-colors hover:border-[var(--nav-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
      >
        <span className="relative h-20 w-20 shrink-0 overflow-hidden rounded-lg bg-[var(--nav-tint)]">
          {item.image ? (
            ...
            <span className="absolute inset-0 grid place-items-center text-brand-link">
        ...
        <span className="flex min-w-0 flex-1 flex-col gap-1">
          <span className="line-clamp-2 font-medium leading-snug text-foreground transition-colors group-hover:text-brand-link">
            {item.title}
          </span>
          ...
          {item.proximity ? (
            <span className="w-fit rounded-full bg-[var(--nav-tint)] px-2 py-0.5 text-[11px] font-medium text-brand-link">
              {item.proximity}
            </span>
          ) : null}
          ...
          <span className={item.area ? "mt-1 grid grid-cols-2 gap-2" : "mt-1 block"}>
            <span className="min-w-0">
              ...
              <span className="block truncate font-heading text-sm font-semibold text-brand-link">{item.price}</span>
            </span>
            {item.area ? (
              <span className="min-w-0">
