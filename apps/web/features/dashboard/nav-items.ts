...
export const DASHBOARD_ROUTE_RULES: readonly DashboardRouteRule[] = [
  ...
  { path: "/dashboard/get-started", exact: true, capabilities: ["shared"] },
  { path: "/dashboard/help-center", exact: true, capabilities: ["shared"] },
  { path: "/dashboard/terms", exact: true, capabilities: ["shared"] },
  { path: "/dashboard/privacy", exact: true, capabilities: ["shared"] },
  { path: "/dashboard/cookies", exact: true, capabilities: ["shared"] },
