            ...
            <CmsWorkspaceLayout
              ...
              editor={<div className="space-y-5">
                <section className="space-y-4 rounded-xl border border-border p-4">
                  ...
                  {active.review_note ? <p className="rounded-lg border border-warning/30 bg-warning/10 p-3 text-sm text-warning"><strong>Reviewer note:</strong> {active.review_note}</p> : null}
