...
// Minimal Sub Admin landing. Deliberately small: this slice only ships
// banners + the property-listing reuse — offers, content blocks, and
// referral-bonus config are deferred to later slices, each adding a card here.
