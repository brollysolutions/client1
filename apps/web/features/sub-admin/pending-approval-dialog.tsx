...
const EMPTY = { search: "", status: "all", line: "all", kind: "all", from: "", to: "" };
        ...
        <div className="contents">
          <DialogContent showCloseButton={false} className={CMS_WORKSPACE_DIALOG_CLASS}>
            ...
            <div className="min-h-0 space-y-4 overflow-y-auto pt-1">
              <CmsFilterBar value={filters} onChange={setFilters} searchLabel="Search approval items" statusOptions={[]} showStatus={false} kindLabel="review types" kindOptions={[{ value: "banner", label: "Banner" }, { value: "property_submission", label: "Property listing" }]} />
